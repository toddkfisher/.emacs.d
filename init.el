...
(use-package org
  ...
  (setq-default org-capture-templates
        '(("n"    "Note"  entry     (file+headline org-default-notes-file "Notes")
           "* %?")
          ("t"    "Todo"  checkitem (file+datetree org-default-notes-file "Todos")
           "[ ] %?")
...
(use-package sr-speedbar
  ...
  (setq sr-speedbar-default-width 22)
  (setq sr-speedbar-max-width 22)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (fill-column-indicator rectangle-utils sr-speedbar imenu-anywhere c-eldoc nasm-mode bury-successful-compilation markdown-mode+ ido-vertical-mode syntax-subword idomenu ido-ubiquitous ido-select-window use-package window-numbering bm move-text smex magit multiple-cursors visual-regexp expand-region peg)))
