...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-dired ido-occur zel rainbow-mode which-key fill-column-indicator rectangle-utils imenu-anywhere nasm-mode bury-successful-compilation markdown-mode+ ido-vertical-mode syntax-subword idomenu ido-ubiquitous ido-select-window use-package window-numbering bm move-text smex magit multiple-cursors visual-regexp expand-region peg))
