...
(use-package speedbar
  ...
  (setq speedbar-ignored-modes (quote (fundamental-mode Info-mode)))
  :config
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (sr-speedbar slime window-numbering windresize ido-occur zel rainbow-mode which-key fill-column-indicator rectangle-utils imenu-anywhere nasm-mode bury-successful-compilation markdown-mode+ ido-vertical-mode syntax-subword idomenu ido-ubiquitous ido-select-window use-package bm move-text smex magit multiple-cursors visual-regexp expand-region peg)))
