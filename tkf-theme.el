...
(setq bg                 "grey55"
      ...
      modeln-fg          "grey15"
      modeln-inactive-fg "grey65"
      modeln-inactive-bg "gray50"
...
(custom-theme-set-faces
 ...
 `(compilation-info                      ((t (:inherit default :foreground ,fg :box t))))
 `(compilation-line-number               ((t (:inherit default :stipple nil :background ,bg :foreground ,fg :inverse-video nil :box t :strike-through nil :overline nil :underline t :slant normal :weight normal :width normal ))))
 `(compilation-warning                   ((t (:inherit default :stipple nil :background ,bg :foreground ,fg :inverse-video nil :box t :strike-through nil :overline nil :underline t :slant normal :weight normal :width normal ))))
 ...
 `(magit-log-author-date-cutoff          ((t (:inherit default))))
 `(magit-log-date                        ((t (:inherit default))))
 `(magit-log-graph                       ((t (:inherit default))))
 `(magit-log-head-label-bisect-bad       ((t (:inherit default))))
 `(magit-log-head-label-bisect-good      ((t (:inherit default))))
 `(magit-log-head-label-default          ((t (:inherit default))))
 `(magit-log-head-label-local            ((t (:inherit default))))
 `(magit-log-head-label-patches          ((t (:inherit default))))
 `(magit-log-head-label-remote           ((t (:inherit default))))
 `(magit-log-head-label-tags             ((t (:inherit default))))
 `(magit-log-message                     ((t (:inherit default))))
 `(magit-log-sha1                        ((t (:inherit default))))
 `(magit-section-title                   ((t (:inherit default))))
 `(magit-tag                             ((t (:inherit default))))
 `(magit-branch                          ((t (:inherit default))))
 `(magit-log-message                     ((t (:inherit default))))
 `(magit-valid-signature                 ((t (:inherit default))))
 `(magit-whitespace-warning-face         ((t (:inherit default))))
 `(magit-log-message                     ((t (:inherit default))))
 `(magit-log-head-label-bisect-bad       ((t (:inherit default))))
 `(magit-log-head-label-bisect-good      ((t (:inherit default))))
 `(magit-valid-signature                 ((t (:inherit default))))
